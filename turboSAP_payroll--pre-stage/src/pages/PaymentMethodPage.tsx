...
export function PaymentMethodPage() {
  ...
  // Determine payment methods status for sidebar indicator
  const getPaymentMethodsStatus = (): 'complete' | 'in-progress' | 'not-started' => {
    if (showResults && paymentResults && paymentResults.length > 0) {
      return 'complete';
    }
    // Check if user has started filling the form
    if (selectedMethods.length > 0 || houseBanks || achSpec || checkVolume || systemCheckRange || manualCheckRange || agreeNoPreNote !== null) {
      return 'in-progress';
    }
    return 'not-started';
  };
    ...
    >
      <div className="max-w-4xl space-y-6">
          ...
          <div className="p-6 space-y-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <input
                ...
                className="mt-1 h-4 w-4 rounded border-border text-primary focus:ring-2 focus:ring-primary/50 focus:ring-offset-2"
              />
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full px-4 py-2 bg-background border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-colors",
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="border border-border rounded-lg p-4 bg-secondary/10">
                  <h3 className="font-medium text-foreground mb-3 flex items-center gap-2">
                    <span className="text-amber-500">●</span> System Generated Check
                  </h3>
                ...
                <div className="border border-border rounded-lg p-4 bg-secondary/10">
                  <h3 className="font-medium text-foreground mb-3 flex items-center gap-2">
                    <span className="text-amber-600">●</span> Manual Check
                  </h3>
                  <div className="space-y-3">
                    <div>
                      <label className="block text-sm font-medium text-foreground mb-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 border border-border rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-foreground mb-2">
                      ...
                      <input
                        ...
                        className={cn(
                          "w-full px-4 py-2 border rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500",
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input
                    ...
                    className="mt-0.5 h-4 w-4 text-amber-600 focus:ring-2 focus:ring-amber-500/50 focus:ring-offset-2"
                  />
                  <div className="flex-1">
        ...
        {showResults && paymentResults && (
          <div className="bg-card border border-border rounded-lg animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="border-t border-border pt-6 mt-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-amber-500 text-white rounded-lg font-medium hover:bg-amber-600 transition-colors flex items-center gap-2 shadow-sm"
                >
                ...
                <div className="rounded-lg border border-border bg-background">
                  <div className="flex items-center justify-between p-4 border-b border-border bg-secondary/30">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-sm bg-amber-500/10 text-amber-600 rounded hover:bg-amber-500/20 transition-colors flex items-center gap-1"
                    >
                          ...
                          <tr key={index} className="border-b border-border last:border-0">
                            <td className="px-4 py-3">
                              <input
                                ...
                                className="w-full px-2 py-1 border border-border rounded bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-amber-500/50"
                              />
                            </td>
                            <td className="px-4 py-3">
                              <input
                  ...
                  <div className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <select
                        ...
                        className="px-4 py-2 border border-border rounded-lg bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                      >
                        <option value="Yes">Yes</option>
                        <option value="No">No</option>
                      </select>
